        ...
        <section className="rounded-lg border border-slate-200 bg-white dark:border-slate-800 dark:bg-[#1c2128]">
          <div className="flex items-center justify-between gap-3 border-b border-slate-200 p-4 dark:border-slate-800">
            ...
            <button
              ...
              className="inline-flex h-8 items-center justify-center gap-1.5 rounded-md bg-orange-600 px-3 text-xs font-semibold text-white hover:bg-orange-500"
            >
            ...
            {accesses.map((access) => (
              ...
              >
                ...
                >
                  ...
                  <span className={cn('h-2.5 w-2.5 shrink-0 rounded-full', access.enabled ? 'bg-emerald-500' : 'bg-slate-400')} />
                </button>
                <button
                  type="button"
                  onClick={(event) => {
                  ...
                  className="mr-3 rounded-md p-1.5 text-slate-400 opacity-0 transition-opacity hover:bg-red-50 hover:text-red-600 group-hover:opacity-100 dark:hover:bg-red-500/10 dark:hover:text-red-400"
                >
